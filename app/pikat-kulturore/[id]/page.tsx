...
// Map pikat kulturore me modelet 3D
const modelMap: { [key: string]: string } = {
  'kalaja': '/3d/kalaja.obj',
  'muzeu-etnografik': '/3d/muzeu.obj',
  'kisha': '/3d/kisha.obj',
  'xhamia-mbret': '/3d/xhamia.obj'
}
...
export default async function CulturalPointDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  const has3DModel = modelMap[point.id]
          ...
          <div className="space-y-8">
            <Tabs defaultValue="description" className="w-full">
              ...
              <TabsContent value="3d" className="animate-in fade-in-50 duration-500">
                {has3DModel ? (
                  <div className="h-[600px] w-full bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl flex flex-col items-center justify-center text-center p-8 border border-primary/20 relative overflow-hidden group">
          ...
          <div className="space-y-6">
            <div className="p-6 border rounded-lg bg-card sticky top-24">
              ...
              <div className="space-y-4">
                ...
                {has3DModel && (
                  <div>
                    <div className="text-sm text-muted-foreground">Pamje 3D</div>
                    <div className="font-medium text-green-600">E disponueshme</div>
                  </div>
                )}
                <div>
